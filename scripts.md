python cli.py register_agent --name "diagnosis_reasoner" --description "Suggest 1–3 likely diagnoses based on structured patient triage data with justifications."
